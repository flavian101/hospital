...
if(isset($_GET["generate_bill"])){
  ...
  $content .= '
      <br/>
      <h2 align ="center"> Medicare Hospital</h2></br>
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i>Medicare hospital</a>
  ...
  <style >
    .bg-primary {
    background: -webkit-linear-gradient(left, #000000,#232060 );
}
                      ...
                      <tr>
                        ...
                        <td>
                          <form method="get">
                              ...
                              <input type = "submit" onclick="alert(' Receipt printed Successfully');" name ="generate_bill" class = "btn btn-success" value="print Receipt"/>
                              </a>
                              </td>
                              </form>
